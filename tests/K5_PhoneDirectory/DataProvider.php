...
class DataProvider
{
    private $dr = "/+1-541-754-3010 156 Alphand_St. <J Steeve>\n 133, Green, Rd. <E Kustur> NY-56423 ;+1-541-914-3010\n"
    ...
    {
        return [
            [[$this->dr, "48-421-674-8974"], "Phone => 48-421-674-8974, Name => Anastasia, Address => Via Quirinal Roma"],
            [[$this->dr, "19-421-674-8974"], "Phone => 19-421-674-8974, Name => C Powel, Address => Chateau des Fosses Strasbourg F-68000"],
            [[$this->dr, "1-921-512-2222"], "Phone => 1-921-512-2222, Name => Wilfrid Stevens, Address => Wild Street AA-67209"],
            [[$this->dr, "1-908-512-2222"], "Phone => 1-908-512-2222, Name => Peter O'Brien, Address => High Street CC-47209"],
            [[$this->dr, "1-541-754-3010"], "Phone => 1-541-754-3010, Name => J Steeve, Address => 156 Alphand St."],

            [[$this->dr, "5-541-984-3012"], "Phone => 5-541-984-3012, Name => Peter Reeves, Address => PO Box 5300 Albertville, SC-28573"],
        ];
    }
}