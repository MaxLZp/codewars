...
class DataProvider
{
    public function data()
    {
        ...
        return [
            [['London', $data1,], [51.199999999999996, 57.42833333333374]],
            [['Beijing', $data1,], [52.416666666666664, 4808.37138888889]],
            [['London', $data2,], [57.03333333333333, 110.90055555555546]],
            [['Beijing', $data2,], [59.083333333333336, 4437.038055555556]],
            [['QWER', $data1,], [-1, -1]],
            [['QWER', $data2,], [-1, -1]],
        ];
    }
